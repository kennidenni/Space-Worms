...
public class Rules {
     ...
     */
    public static boolean outOfBoard(int maxValue, int tryPos) {
        return tryPos > maxValue;
    }
     ...
     */
    private static boolean canWalkThisWay(String dir, int square, int times, String API, int maxSquare) {
        int currPos = square;
        for (int i = 0; i < times; i++) {
            if (outOfBoard(maxSquare, currPos + i)) {
                return false;
            }
